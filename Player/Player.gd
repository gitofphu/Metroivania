...
export (int) var MAX_WALL_SLIDE_SPEED = 48
export (int) var JUMP_FORCE = 128
export (int) var MAX_SLOPE_ANGEL = 46
...
onready var coyoteJumpTime = $CoyoteJumpTimer
...
func jump_check():
	if is_on_floor() or coyoteJumpTime.time_left > 0:
...
func move():
	...
	motion = move_and_slide_with_snap(motion, snap_vector * 4, Vector2.UP, true, 4, deg2rad(MAX_SLOPE_ANGEL))
	# Landing
